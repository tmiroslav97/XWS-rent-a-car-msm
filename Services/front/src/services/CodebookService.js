...
const FINALPOINTS = {
    CAR_MANUFACTURER_BASE: '/codebook/car-man',
    CAR_TYPE_BASE: '/codebook/car-type',
    FUEL_TYPE_BASE: '/codebook/fuel-type',
    GEARBOX_TYPE_BASE: '/codebook/gb-type',
    CAR_MODEL_BASE: '/codebook/car-model'
};
