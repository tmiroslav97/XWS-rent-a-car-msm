...
VALUES (1, 'PENDING', STR_TO_DATE('16.06.2020 22:49:00','%d.%m.%Y %H:%i:%S'), 5, 3, STR_TO_DATE('22.06.2020 10:00:00','%d.%m.%Y %H:%i:%S'), STR_TO_DATE('26.06.2020 10:00:00','%d.%m.%Y %H:%i:%S'), false);
